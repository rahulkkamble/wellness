...
/*
  ...
  - Single practitioner (from window.GlobalPractitioner FHIR object) used as author/attester/performer
  - Generates a NDHM-friendly FHIR Bundle (Composition, Patient, Practitioner, Observations)
  - Additions:
    - Practitioner sourced from window.GlobalPractitioner with safe fallbacks (id/name/license)
    ...
    identifier: [
      {
        ...
        type: {
          coding: [{ system: V2_0203, code: "MD", display: "Medical License number" }],
